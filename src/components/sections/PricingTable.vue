...
<template>
  <section id="pricing" :class="isArabic ? 'rtl' : 'ltr'" class="py-20 px-4 text-white relative">
    ...
    >
      <!-- Background shadows -->
      <div
        class="absolute -bottom-16 -left-16 -right-16 top-40 rounded-[60px] bg-white opacity-[0.03]"
      ></div>
      <div
        class="absolute -bottom-8 -left-8 -right-8 top-20 rounded-[40px] bg-white opacity-[0.04] hidden md:block"
      ></div>
      ...
      <div class="overflow-x-auto">
        ...
        <!-- TABLE HEADER -->
        <div
          class="min-w-[650px] md:min-w-0 grid grid-cols-6 
        ...
        <div class="mt-4 space-y-4 min-w-[650px] md:min-w-0">
          ...
          >
            ...
            <div class="flex items-center gap-2 md:gap-3">
              <img :src="row.logo" class="w-8 md:w-12" />
            ...
            <div class="flex justify-center">
              <button
                class="px-3 md:px-5 py-1.5 md:py-2 rounded-full 
                       text-[9px] md:text-sm font-medium transition"
                :class="
                  row.id === selectedId
